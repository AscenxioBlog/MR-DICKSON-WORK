...
<footer class="bg-[#424242] dark:bg-gray-900">
    <div class="container px-6 py-8 mx-auto">
        <div class="flex flex-col items-center text-center">
            <Link to="#">
            <h1 className=' font-custom text-[20px] md:text-3xl font-bold text-white'> BABAKAZO GADGET </h1>
        ...
        <div class="flex flex-col items-center sm:flex-row sm:justify-between">
            <p class="text-sm text-white dark:text-gray-300"> &copy; {new Date().getFullYear()} BABAKAZO GADGET. All Rights Reserved.</p>
